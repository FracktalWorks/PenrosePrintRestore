...
plugin_identifier = "PenrosePrintRestore"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_PenrosePrintRestore"
# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Octoprint-PenrosePrintRestore"
...
# module
plugin_description = """Print Restore plugin for Penrose series"""
...
plugin_url = "https://github.com/FracktalWorks/PenrosePrintRestore"
