...
* if autoRestore is enabled from Settings > PenrosePrintRestore on the Octoprint Browser Instance, the printer will automatically restore the print after power failure on restart

## Compatibility:
* Julia Advanced, PenroseAdvancedTouchUI 1.0.3 or higher
* Julia Extended, PenroseExtendedTouchUI 1.0.21 or higher
* Julia Pro SinglePenroseProSingleTouchUI 0.0.5 or highers
* Julia Pro Dual, PenroseProDualTouchUI 0.0.10 or higher

## Instalation:
*Make sure you have the latest version of the respective TouchScreen UI. Check for updates before proceeding*

1. Copy latest SourceCode(zip) link address from [here](https://github.com/FracktalWorks/PenrosePrintRestore/releases)
